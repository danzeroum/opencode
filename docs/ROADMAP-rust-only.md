...
>
> **Rotas nativas contrato-enforçadas: 45 paths** · PRs desta rodada autônoma: #69–#107.
...
- ✅ 1w — `v2.fs.find` (`GET /api/fs/find`, busca real arquivos+dirs via `opencode_tools::find_entries`, filtro `type` + `limit`) — **#107**; resta `v2.fs.read` (path wildcard + corpo raw)
