...
- ⬜ Next: openai-responses (text SSE — the Responses API, distinct from openai-chat) to complete the protocol portfolio; then the deferred Bedrock SigV4/live transport. No public cutover (the runner consumes these; Phase 4).
