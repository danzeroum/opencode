...
- ⬜ Next: `route/executor.ts` (retry/backoff + redaction, consuming `Status::retryable`); then openai-chat → openai-responses → gemini → bedrock-converse. No public cutover (the runner consumes it; Phase 4).
