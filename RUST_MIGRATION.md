...
- ⬜ Next: bedrock-converse (the AWS `vnd.amazon.eventstream` binary framing + SigV4 — the actual binary one) → openai-responses. No public cutover (the runner consumes it; Phase 4).
