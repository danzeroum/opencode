export const dict = {
  ...
  "settings.providers.test.testing": "Testing…",
  "settings.providers.test.success.title": "Connection successful",
  "settings.providers.test.success.description": "{provider} responded successfully.",
  "settings.providers.test.success.descriptionModels": "{provider} responded — {models} models available.",
  "settings.providers.test.failure.title": "Connection failed",
  "settings.models.title": "Models",
  "settings.models.description": "Model settings will be configurable here.",
  "settings.config.title": "Configuration",
  "settings.config.cascade": "Precedence cascade",
  "settings.config.readOnly": "Read-only",
  "settings.config.notSet": "Not set",
  "settings.config.loading": "Loading…",
  "settings.overview.title": "Overview",
  "settings.overview.agents": "Agents",
  "settings.overview.agents.sub": "{count} primary",
  "settings.overview.providers": "Providers",
  "settings.overview.providers.sub": "connected",
  "settings.overview.commands": "Commands",
  "settings.overview.models": "Models",
  "settings.policies.title": "Policies",
  "settings.policies.new": "New rule",
  "settings.policies.add": "Add",
  "settings.policies.added": "Policy rule added",
  "settings.policies.removed": "Policy rule removed",
  "settings.policies.empty": "No policy rules",
  ...
  "settings.snapshots.title": "Snapshots",
  "settings.snapshots.new": "Create snapshot",
  "settings.snapshots.create": "Create",
  "settings.snapshots.created": "Snapshot created",
  "settings.snapshots.restore": "Restore",
  "settings.snapshots.restored": "Snapshot restored",
  "settings.snapshots.restoreFailed": "Restore failed",
  "settings.snapshots.empty": "No snapshots",
  "settings.snapshots.section.list": "Snapshots",
  "settings.snapshots.field.message": "Label",
  "settings.snapshots.field.messagePlaceholder": "before refactor",
  "settings.section.extensions": "Extensions",
  "settings.extensions.title": "Extensions",
  "settings.extensions.mcp": "MCP servers",
  "settings.extensions.mcp.empty": "No MCP servers connected",
  "settings.extensions.integrations": "Integrations",
  "settings.extensions.integrations.empty": "No integrations available",
  "settings.extensions.connected": "Connected",
  "settings.extensions.plugins": "Plugins",
  "settings.extensions.plugins.note": "Plugin management isn't available in the web console yet.",
  "settings.extensions.mcp.new": "Add MCP server",
  "settings.extensions.mcp.enable": "Enable",
  "settings.extensions.mcp.disable": "Disable",
  "settings.extensions.mcp.status.connected": "Connected",
  "settings.extensions.mcp.status.disabled": "Disabled",
  "settings.extensions.mcp.status.failed": "Failed",
  "settings.extensions.mcp.status.needsAuth": "Needs auth",
  "settings.mcp.edit.titleNew": "Add MCP server",
  "settings.mcp.edit.titleEdit": "Edit MCP server",
  "settings.mcp.edit.field.name": "Name",
  "settings.mcp.edit.field.type": "Type",
  "settings.mcp.edit.type.local": "Local (stdio)",
  "settings.mcp.edit.type.remote": "Remote (HTTP)",
  "settings.mcp.edit.field.command": "Command",
  "settings.mcp.edit.field.cwd": "Working directory",
  "settings.mcp.edit.field.url": "URL",
  "settings.mcp.edit.field.headers": "Headers (one per line, Key: Value)",
  "settings.mcp.edit.field.enabled": "Enabled",
  "settings.mcp.edit.error.name": "Name is required",
  "settings.mcp.edit.error.command": "Command is required",
  "settings.mcp.edit.error.url": "URL is required",
  "settings.mcp.edit.saved": "Saved MCP server {name}",
  "settings.agents.title": "Agents",
  "settings.agents.description": "Agent settings will be configurable here.",
  "settings.agents.empty": "No custom agents",
  "settings.agents.deleted": "Deleted agent {name}",
  ...
  "settings.agents.edit.titleNew": "New agent",
  "settings.agents.edit.titleEdit": "Edit agent",
  "settings.agents.edit.field.name": "Name",
  "settings.agents.edit.field.description": "Description",
  "settings.agents.edit.field.mode": "Mode",
  "settings.agents.edit.field.model": "Model",
  "settings.agents.edit.field.system": "System prompt",
  "settings.agents.edit.field.color": "Color",
  "settings.agents.edit.field.steps": "Step limit",
  "settings.agents.edit.field.hidden": "Hidden",
  "settings.agents.edit.error.name": "Name is required",
  "settings.agents.edit.saved": "Saved agent {name}",
  ...
  "settings.commands.edit.titleNew": "New command",
  "settings.commands.edit.titleEdit": "Edit command",
  "settings.commands.edit.field.name": "Name",
  "settings.commands.edit.field.description": "Description",
  "settings.commands.edit.field.agent": "Agent",
  "settings.commands.edit.field.model": "Model",
  "settings.commands.edit.field.template": "Template",
  "settings.commands.edit.field.subtask": "Run as subtask",
  "settings.commands.edit.error.name": "Name is required",
  "settings.commands.edit.error.template": "Template is required",
  "settings.commands.edit.saved": "Saved command {name}",
